...
import com.example.akisame_lin.love_air2.presenter.NewsAdapter;
        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    for (int i = 1; i <= 1; i++) {
                        Log.d(TAG, "run: ");
                        Document doc = Jsoup.connect("http://www.chndaqi.com/news/list?cid=head&page=" + Integer.toString(i)).get();
